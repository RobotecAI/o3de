...
namespace PhysX
{
    namespace
    {
        ...
        physx::PxD6JointDrive ConvertD6JointDriveToPxD6Drive(const D6JointDrive& d6JointDrive)
        {
            ...
            const bool isAcceleration = (d6JointDrive.m_driveFlag ==  D6JointDriveFlag::Acceleration); // Currently not exposed in the configuration

            return physx::PxD6JointDrive(stiffness, damping, forceLimit, isAcceleration);
        }

        //! Axis ID mapping for D6 joints: 0=X, 1=Y, 2=Z, 3=Twist, 4=Swing, 5=Slerp
        const AZStd::unordered_map<int, physx::PxD6Axis::Enum> idToPxD6AxisEnum = {
            {0, physx::PxD6Axis::eX},
            {1, physx::PxD6Axis::eY},
            {2, physx::PxD6Axis::eZ},
            {3, physx::PxD6Axis::eTWIST},
            {4, physx::PxD6Axis::eSWING1},
            {5, physx::PxD6Axis::eSWING2}
        };

        const AZStd::unordered_map<int, physx::PxD6Drive::Enum> idToPxD6DriveEnum = {
            {0, physx::PxD6Drive::eX},
            {1, physx::PxD6Drive::eY},
            {2, physx::PxD6Drive::eZ},
            {3, physx::PxD6Drive::eTWIST},
            {4, physx::PxD6Drive::eSWING},
            {5, physx::PxD6Drive::eSLERP}
        };
        ...
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if (auto* editContext = serializeContext->GetEditContext())
            {
                ...
                editContext->Class<D6JointComponentConfiguration>("D6 Joint Configuration", "Configuration for D6 joint motion")
                           ->DataElement(
                               AZ::Edit::UIHandlers::ComboBox,
                               &D6JointComponentConfiguration::m_motionX,
                               "Motion X",
                           ...
                           ->DataElement(
                               AZ::Edit::UIHandlers::ComboBox,
                               &D6JointComponentConfiguration::m_motionY,
                               "Motion Y",
                           ...
                           ->DataElement(
                               AZ::Edit::UIHandlers::ComboBox,
                               &D6JointComponentConfiguration::m_motionZ,
                               "Motion Z",
    ...
    void D6JointComponent::InitNativeJoint()
    {
        ...
        else
        {
            AZ_Warning(
                "PhysX",
                false,
                "Entity [%s] Hinge Joint component missing lead entity. This joint will be a global constraint on the follower's global position.",
        ...
        if (auto* sceneInterface = AZ::Interface<AzPhysics::SceneInterface>::Get())
        {
            ...
            m_nativeD6Joint->setMotion(
                physx::PxD6Axis::eX,
                ConvertD6JointAxisToPxD6Motion(m_d6Configuration.m_motionX));

            m_nativeD6Joint->setMotion(
                physx::PxD6Axis::eY,
                ConvertD6JointAxisToPxD6Motion(m_d6Configuration.m_motionY));

            m_nativeD6Joint->setMotion(
                physx::PxD6Axis::eZ,
                ConvertD6JointAxisToPxD6Motion(m_d6Configuration.m_motionZ));

            m_nativeD6Joint->setMotion(
                physx::PxD6Axis::eTWIST,
                ConvertD6JointAxisToPxD6Motion(m_d6Configuration.m_motionTwist));

            m_nativeD6Joint->setMotion(
                physx::PxD6Axis::eSWING1,
                ConvertD6JointAxisToPxD6Motion(m_d6Configuration.m_motionSwing1));

            m_nativeD6Joint->setMotion(
                physx::PxD6Axis::eSWING2,
                ConvertD6JointAxisToPxD6Motion(m_d6Configuration.m_motionSwing2));

            // Set linear limits per axis
            if (m_d6Configuration.m_motionX == D6JointAxis::Limited)
            {
                physx::PxJointLinearLimitPair limitX(
                    m_d6Configuration.m_motionLimitsX.first,
                    m_d6Configuration.m_motionLimitsX.second);
                m_nativeD6Joint->setLinearLimit(physx::PxD6Axis::eX, limitX);
            }

            if (m_d6Configuration.m_motionY == D6JointAxis::Limited)
            {
                physx::PxJointLinearLimitPair limitY(
                    m_d6Configuration.m_motionLimitsY.first,
                    m_d6Configuration.m_motionLimitsY.second);
                m_nativeD6Joint->setLinearLimit(physx::PxD6Axis::eY, limitY);
            }

            if (m_d6Configuration.m_motionZ == D6JointAxis::Limited)
            {
                physx::PxJointLinearLimitPair limitZ(
                    m_d6Configuration.m_motionLimitsZ.first,
                    m_d6Configuration.m_motionLimitsZ.second);
            ...
            if (m_d6Configuration.m_motionTwist == D6JointAxis::Limited)
            {
                physx::PxJointAngularLimitPair twistLimit(
                    m_d6Configuration.m_motionLimitsTwist.first,
                    m_d6Configuration.m_motionLimitsTwist.second);
                m_nativeD6Joint->setTwistLimit(twistLimit);
            }

            // Set swing limits
            if (m_d6Configuration.m_motionSwing1 == D6JointAxis::Limited ||
                m_d6Configuration.m_motionSwing2 == D6JointAxis::Limited)
            {
                physx::PxJointLimitCone swingLimit(
                    m_d6Configuration.m_motionLimitsCone.first,
                    m_d6Configuration.m_motionLimitsCone.second);
                m_nativeD6Joint->setSwingLimit(swingLimit);
            }

            if (m_d6Configuration.m_driveX.m_driveType != D6JointDriveType::None)
            {
                m_nativeD6Joint->setDrive(
                    physx::PxD6Drive::eX,
                    PhysX::ConvertD6JointDriveToPxD6Drive(m_d6Configuration.m_driveX));
            }
            ...
            if (m_d6Configuration.m_driveY.m_driveType != D6JointDriveType::None)
            {
                m_nativeD6Joint->setDrive(
                    physx::PxD6Drive::eY,
                    PhysX::ConvertD6JointDriveToPxD6Drive(m_d6Configuration.m_driveY));
            }
            ...
            if (m_d6Configuration.m_driveZ.m_driveType != D6JointDriveType::None)
            {
                m_nativeD6Joint->setDrive(
                    physx::PxD6Drive::eZ,
                    PhysX::ConvertD6JointDriveToPxD6Drive(m_d6Configuration.m_driveZ));
            }
            if (m_d6Configuration.m_driveTwist.m_driveType != D6JointDriveType::None)
            {
                m_nativeD6Joint->setDrive(
                    physx::PxD6Drive::eTWIST,
                    PhysX::ConvertD6JointDriveToPxD6Drive(m_d6Configuration.m_driveTwist));
            }
            if (m_d6Configuration.m_driveSwing.m_driveType != D6JointDriveType::None)
            {
                m_nativeD6Joint->setDrive(
                    physx::PxD6Drive::eSWING,
                    PhysX::ConvertD6JointDriveToPxD6Drive(m_d6Configuration.m_driveSwing));
            }
            if (m_d6Configuration.m_driveSlerp.m_driveType != D6JointDriveType::None)
            {
                m_nativeD6Joint->setDrive(
                    physx::PxD6Drive::eSLERP,
                    PhysX::ConvertD6JointDriveToPxD6Drive(m_d6Configuration.m_driveSlerp));
            }
        }
    ...
    AZStd::pair<AZ::Vector3, AZ::Vector3> D6JointComponent::GetVelocityGeneral() const
    {
        ...
        return AZStd::make_pair(
            AZ::Vector3(linearVel.x, linearVel.y, linearVel.z),
            AZ::Vector3(angularVel.x, angularVel.y, angularVel.z));
    }
    ...
    void D6JointComponent::SetVelocityGeneral(const AZ::Vector3& linear, const AZ::Vector3& angular)
    {
        ...
        m_nativeD6Joint->setDriveVelocity(
            physx::PxVec3(linear.GetX(), linear.GetY(), linear.GetZ()),
            physx::PxVec3(angular.GetX(), angular.GetY(), angular.GetZ()));
    }
