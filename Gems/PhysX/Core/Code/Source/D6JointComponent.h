...
namespace PhysX
{
    ...
    AZ_ENUM_CLASS_WITH_UNDERLYING_TYPE(D6JointAxis, uint8_t,
        Free,
        Limited,
        Locked
    );
    ...
    AZ_ENUM_CLASS_WITH_UNDERLYING_TYPE(D6JointDriveType, uint8_t,
        None,
        Position,
        Velocity
    );
    ...
    AZ_ENUM_CLASS_WITH_UNDERLYING_TYPE( D6JointDriveFlag, uint8_t,
        Force,
        Acceleration
    );
    ...
    struct D6JointDrive
    {
        ...
        bool IsActive() const { return m_driveType != D6JointDriveType::None; }
    };
    ...
    struct D6JointComponentConfiguration
    {
        ...
        bool IsXLimited() const { return m_motionX == D6JointAxis::Limited; }
        bool IsYLimited() const { return m_motionY == D6JointAxis::Limited; }
        bool IsZLimited() const { return m_motionZ == D6JointAxis::Limited; }
        bool IsTwistLimited() const { return m_motionTwist == D6JointAxis::Limited; }
        bool IsSwing1Limited() const { return m_motionSwing1 == D6JointAxis::Limited; }
        bool IsSwing2Limited() const { return m_motionSwing2 == D6JointAxis::Limited; }
    };
    ...
    public:
        ...
        void* GetNativeJointPointer() const override { return m_nativeD6Joint; }
    protected:
